      ...
      subGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Территория людей на Севере', path: '/map/north-humans' },
            { label: 'Земли эльфов на Севере', path: '/map/north-elves' },
            { label: 'Владения дворфов на Севере', path: '/map/north-dwarves' },

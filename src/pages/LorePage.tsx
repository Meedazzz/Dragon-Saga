...
const loreDatabase: Record<string, LoreData> = {
  ...
  sakris: {
    name: 'Сакрис Ульриаш',
    title: 'Драконид из Бергхейма, беглец за пределы привычных троп',
    bio: [
      'Сакрис вырос в Бергхейме — небольшой северной деревне среди лесов, камня и морозного ветра. Это место держится на охоте, козоводстве, руде и привычке выживать вместе. Его семья была частью этой суровой общины: отец Раксис защищал деревню и работал плотником, мать Гиракса была охотницей, кожевницей и учила детей лесу на практике, а старшая сестра Сиракс рано стала одной из лучших среди молодых охотников.',
      'С детства Сакрис отличался выносливостью, наблюдательностью и тягой к одиночным вылазкам, но в грубой силе уступал ровесникам. Его редко брали на дальние охоты, считая это вопросом безопасности. Он соперничал с Оттаром Айронсайдом и Кьяртаном Аккерлундом, проигрывал в прямой силе, но не ломался, снова вставал и искал иной путь.',
      'Первым близким другом Сакриса был Бьярни Миловар. После гибели Бьярни от медведицы Сакрис ещё сильнее отдалился от ровесников. Теплее всех к нему относились Алдрик, староста и бывший южный архивариус, научивший его орочьему языку как тайной речи, Сигрид Миловар, видевшая в нём старшего брата, и Астрид Локен, которая находила красоту в узорах его чешуи.',
      'На Сакриса повлияли и те, кто жил на краю общины. Тормхен Одноглазый приносил слухи о дальних землях, Вельма-травница учила ядам, ранам и выживанию, а изгнанная скальдиха Юна рассказывала не книжные легенды, а настоящие истории о городах, караванах и людях за пределами Севера. Именно Юна первой сказала ему, что он похож на волка в клетке для кроликов.',
      'Рутина Бергхейма давила сильнее с каждым годом. Сакрис хотел увидеть Нортвинд, новые земли и чужие дороги, но семья не могла или не хотела отпустить его одного. После очередной ссоры он собрал вещи, оставил записку: «Не ищите меня, со мной всё будет хорошо, Сакрис» — и ушёл к торговой тропе, зная, что скоро пройдёт караван.',
      'Почти год он не возвращался домой. Для Сакриса Бергхейм остаётся не просто местом рождения, а узлом незавершённых разговоров: с семьёй, соперниками, теми, кто верил в него, и теми, кто считал ошибкой природы. Он ушёл не из ненависти к деревне, а потому что иначе боялся навсегда остаться тем, кем его решили видеть другие.',
    ],
    deeds: [
      'Выжил в суровом быту Бергхейма, научившись охоте, скрытности, травничеству и осторожности там, где грубой силы было недостаточно.',
      'Сохранил волю после смерти Бьярни и долгих лет соперничества с Оттаром, Вигго и другими ровесниками.',
      'Освоил орочий язык у Алдрика и сделал его тайным языком доверия и личной памяти.',
      'Покинул Бергхейм самостоятельно, примкнув к каравану на Нортвинд, чтобы найти собственный путь за пределами деревни.',
    ],
    traits: {
      character: 'Молчаливый, упрямый и наблюдательный. Предпочитает одиночество, малые группы и дело словам.',
      ideal: '«Если мир шире деревенской стены, я должен увидеть его сам.»',
      bond: 'Семья, Алдрик, память о Бьярни и Бергхейм — всё, от чего он ушёл, но что продолжает определять его путь.',
      flaw: 'Бежит от тесных рамок быстрее, чем успевает объяснить близким, почему ему нужно уйти.',
    },
    motto: '«Не ищите меня. Со мной всё будет хорошо.»',

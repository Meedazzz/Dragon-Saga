      ...
      <div className={isFullscreen ? 'p-0' : 'max-w-[1200px] mx-auto px-4 md:px-8 pb-20 pt-16'}>
        ...
        <motion.div
          ...
          className={
            isFullscreen
              ...
              : 'relative w-full min-h-[360px] max-h-[78vh] overflow-hidden rounded-xl border-2 shadow-2xl bg-[#0c0a08] select-none cursor-grab active:cursor-grabbing'
          }
          style={{
            aspectRatio: isFullscreen ? 'auto' : (mapAspectRatio ? `${mapAspectRatio}` : '1.83/1'),
        ...
        >
          ...
          <img
            ...
            draggable={false}
            onLoad={(e) => setMapAspectRatio(e.currentTarget.naturalWidth / e.currentTarget.naturalHeight)}
            style={{
              display: 'block',

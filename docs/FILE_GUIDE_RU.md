...
- `src/data/lorebook.ts` — Новый лорбук: 50 страниц бестиария, НПС, фракций, локаций, магии, языков и военных машин Иллирии, расширенной нежити, вампиров, големов, элементалей, сельванов и совомедведей.
...
- `tests/ui-smoke.spec.ts` — UI smoke-тест: desktop/tablet/mobile, Таро, активности, лорбук, военные машины, цвета героев.
